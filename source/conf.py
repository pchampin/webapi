# -*- coding: utf-8 -*-
#
# Programmation Web Client Riche documentation build configuration file, created by
# sphinx-quickstart on Thu Jan  8 18:52:38 2015.
#
...
project = u'API Web'
copyright = u'2015, Pierre-Antoine Champin & Michael Mrissa'
...
latex_documents = [
  ('index', 'APIWeb.tex', u'API Web',
   u'Pierre-Antoine Champin \\& Michael Mrissa', 'manual'),
]
...
man_pages = [
    ('index', 'apiweb', u'API Web',
     [u'Pierre-Antoine Champin & Michael Mrissa'], 1)
]
...
texinfo_documents = [
  ('index', 'APIWeb', u'API Web',
   u'Pierre-Antoine Champin & Michael Mrissa', 'APIWeb', 'One line description of project.',
   'Miscellaneous'),
]
