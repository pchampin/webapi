...
__ http://dsi-liris-silex.univ-lyon1.fr/apiweb/blogephem/apidoc
...
* Le « consructeur » ne crée pas un nouveau blog ;
...
* La méthode ``createArticle`` pourra s'inspirer de ce que vous avez fait à la séance précédente,
  mais il est également possible de poster du XML plutôt que des données de formulaire.
