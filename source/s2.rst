...
__ http://docs.oracle.com/javase/7/docs/api/javax/xml/parsers/package-summary.html
...
#. en utilisant le verbe ``HEAD`` lorsque c'est possible ;
#. en affichant le type de contenu de la réponse ;
#. en ne recherchant les liens que si le contenu est du HTML ;
#. en catégorisant les liens trouvés par type de contenu...
